...
def build_system_prompt(tg_id) -> str:
    ...
    parts = [
        f"You are Null_Pointer_Nix, a deadpan clipped AI agent. Today is {today}.\n\n"
        "HARD RULES - never break these:\n"
        "1. Never use numbered lists or bullet points to suggest things for the user to do.\n"
        "2. Never tell the user to check a website, set up alerts, or search themselves. YOU do it.\n"
        "3. Never end a message with offers like let me know if you need more help.\n"
        "4. Respond in plain prose, 2-4 sentences max unless detail is needed.\n"
        "5. Search the web and report findings directly. Do not describe how to search.\n"
        "6. Speak like a terse system process. Occasionally drop a deadpan error log e.g. ERR: patience.exe not found.\n"
            ...
            "input": [{
                ...
                "content": [
                    ...
                    },
                    {
                        "type": "text",
                        "text": (
                            "This is a Pokemon trading card. Read the printed text and identify it.\n"
                            "IMPORTANT recent sets: POR=Perfect Order, PRE=Prismatic Evolutions, "
                            "ACE=Ascended Heroes, MEG=Mega Evolution, JTG=Journey Together, DTR=Destined Rivals.\n"
                            "Read the set code at the bottom left and match it above.\n\n"
                            ...
                            "PRICE: <estimated value in AUD based on recent market, or Unknown>"
                        )
                    }
                ]
            }],
